...
const Footer = () => {
  return (
    <footer className="relative mt-24 bg-[#080431]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* Bottom */}
        <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-300 dark:text-gray-400">
